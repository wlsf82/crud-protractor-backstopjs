...
This document describes the Backbase assignment for the role of QA engineer and then demonstrates a possible solution.
...
>To have a HTML report automatically opened after test execution, set `"report": ["browser"]` on `test/visual/backstop.json` file.
